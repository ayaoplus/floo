 ...
 * Dashboard 首页
 *
 * 展示系统总览:批次/任务统计 + health 摘要 + 最近活动 + 批次概览
 * 客户端 AutoRefresh 5s 触发 Server Component 重渲染
 */
...
import { HealthCard, HealthIssuesList } from '@/components/health-card';
...
export default async function DashboardPage() {
  ...
  const health = deriveHealth(allTasks);
    ...
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="mb-10 flex items-start justify-between">
        <div>
          ...
          <p className="text-olive-gray">Multi-Agent Vibe Coding Harness</p>
        </div>
      ...
      {/* health 详情(level !== ok 时才显示) */}
      <HealthIssuesList health={health} />
